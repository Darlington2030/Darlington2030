...
class UI {
    ...
    addCartItem(cartItem) {
        ...
        <div class="cart-product-name"><h3>${cartItem.tittle}</h3></div>
        <div class= "cart-product-price"></h3></div>
    ...
    cartLogic() {
        ...
        cartContent.addEventListener("click", (event) => {
            ...
            } else if (event.classList.contains("add-amount")) {
                let id = event.target.dataset.id
